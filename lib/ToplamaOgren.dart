...
class ToplamaOgren extends StatefulWidget {
  @override
  _ToplamaOgrenState createState() => _ToplamaOgrenState();
}

class _ToplamaOgrenState extends State<ToplamaOgren> {
  late int number1;
  late int number2;
  late int result;
