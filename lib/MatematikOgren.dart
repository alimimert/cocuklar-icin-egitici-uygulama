...
class MatematikOgren extends StatefulWidget {
  @override
  _MatematikOgrenState createState() => _MatematikOgrenState();
}

class _MatematikOgrenState extends State<MatematikOgren> {
  late int number1;
  late int number2;
  late int result;
